...
public class vThirdPersonCamera : MonoBehaviour
{
    ...
    /// 当前相机的模式
    /// </summary>
    public CameraMode currentCameraMode = CameraMode.FellowMode;
    /// <summary>
    /// 是否可以进行视角的缩放
    /// </summary>
    ...
    public float wheelMouseSensitivity = 3f;
    public float yMinLimit = -40f;
    public float yMaxLimit = 80f;
    public float wheelMinLimit = 0f;
    public float wheelMaxLimit = 3f;
        ...
        switch (currentCameraMode)
        {
            ...
            case CameraMode.FellowMode:
                ...
                if (Input.GetMouseButton(1))
                {
                    ...
                    xMouseSensitivity = 12f;
                    yMouseSensitivity = 12f;
    ...
    public void ZoomCamera(float wheelValue)
    {
        if (isScrollWheel)
        {
            defaultDistance += wheelValue * wheelMouseSensitivity;
            defaultDistance = vExtensions.ClampAngle(defaultDistance, wheelMinLimit, wheelMaxLimit);
        }        
    }
