...
namespace EPOOutline
{
    ...
    public class OutlinableEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var color = serializedObject.FindProperty("outlineColor");
            ...
            EditorGUILayout.HelpBox("In order to use alpha you have to enable info buffer in the Outliner/SRPOutlineFeature", MessageType.Info);

            color.colorValue = EditorGUILayout.ColorField(new GUIContent("Outline color"), color.colorValue, true, true, true);
