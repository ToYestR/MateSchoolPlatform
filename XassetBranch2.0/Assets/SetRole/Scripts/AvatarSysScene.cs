...
public class AvatarSysScene : MonoBehaviour
{
    public static AvatarSysScene _instance;
    private Transform girlSourceTrans;//女孩资源模型的位置
    public GameObject girlTarget;//女孩骨骼模型，换装的目标
    ...
    public GameObject boyTarget;//男孩骨骼模型，换装的目标
    ...
    public int sexCount;//0代表小女孩，1代表小男孩
    ...
    public string jsontestest;
    [Header("所用到的系列物体")]
    public GameObject goGril;
    ...
    //         // sexJson = JsonConvert.SerializeObject(sexCount);
    //     }
    //     else
    //     {
    //         sexCount = 0;
